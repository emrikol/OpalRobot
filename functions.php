...
function opalrobot_scripts() {
	wp_enqueue_style( 'opalrobot-style', get_stylesheet_uri() );

	wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css?family=Open+Sans+Condensed:300,700', array( 'opalrobot-style') );
